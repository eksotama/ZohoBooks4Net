...
namespace ZohoBooks4Net.Requests
{
    public class PaymentRefundRequest
    {
        ...
        /// <summary>
        /// Exchange rate for the currency used in the invoices and customer's currency. The payment amount would be the multiplicative
        /// product of the original amount and the exchange rate.
        /// </summary>

...
namespace ZohoBooks4Net
{
    public abstract class ClientBase
    {
        ...
        public event EventHandler<Events.ZohoBooksResponseEventArgs> RequestCompleted;
        ...
        {
            var responseEventArgs = new Events.ZohoBooksResponseEventArgs { Request = request, Response = response };
